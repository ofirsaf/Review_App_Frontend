    ...
    <div className="flex items-center justify-between relative">
      <input
        ...
        className="border-2 dark:border-dark-subtle border-light-subtle
         dark:focus:border-white focus:border-primary dark:text-white transition bg-transparent
          rounded text-lg p-1 outline-none"
        placeholder="Search Movies..."
      />
      <div className="flex items-center flex-3 space-x-3">
        <button
          onClick={toggleTheme}
        ...
        <button
          ...
          className="flex items-center space-x-2 dark:border-dark-subtle border-light-subtle
           hover:border-primary dark:text-dark-subtle text-light-subtle
...
const CreateOptions = ({ visible, onClose }) => {
  ...
  return (
    <div
      id={containerID}
      ref={container}
      className="absolute right-0 top-12 flex flex-col space-y-3 p-5 dark:bg-secondary
